...
function repairCommand.initConfigUI(scrollframe, pos, size)
    ...
    cc.l.uiElementToSettingMap[comboBox.index] = {name = "repairStopOrder", default = FighterOrders.Return}
    ...
    cc.l.uiElementToSettingMap[checkBox.index] = {name = "repairFriendlySetting", default = false}
    ...
    cc.l.uiElementToSettingMap[checkBox.index] = {name = "repairLowHPSetting", default = false}
